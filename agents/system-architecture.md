...
These rules are non-negotiable. They are distilled from [docs/architecture.md](../docs/architecture.md) and the full reference set. In any conflict between these rules and any other source, these rules win.
