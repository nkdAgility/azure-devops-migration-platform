...
- Module orchestrator abstractions use one symmetric phase shape (`CaptureAsync`, `ExportAsync`, `PrepareAsync`, `ImportAsync`, `ValidateAsync`), mirroring the five pipeline phases.
