...
Stage label values are canonical and shared with the cursor schema. See [.agents/30-context/checkpointing-summary.md](checkpointing-summary.md) for the full enum.
