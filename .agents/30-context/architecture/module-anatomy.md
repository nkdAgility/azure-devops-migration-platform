...
- `IModule` execution lifecycle (CaptureAsync, ExportAsync, etc.) — see `.agents/30-context/module-model.md`
- Connector capability gaps for optional Data entries — see `.agents/30-context/connector-model.md`
- Package content written by Data entries — see `.agents/30-context/migration-package-concept.md`
- Phase in which Processing entries run — see `.agents/30-context/pipeline-phases.md`
