...
**Subsystem implementation map:** core classes, tests, and execution diagrams. For checkpointing behavior model, cursor schema, resume logic, and phase tracking semantics, see [.agents/30-context/checkpointing-summary.md](../domains/checkpointing-summary.md).
...
- [.agents/30-context/checkpointing-summary.md](../domains/checkpointing-summary.md)
- [docs/adr/0003-cursor-based-checkpointing.md](../../../docs/adr/0003-cursor-based-checkpointing.md)
- [../../20-guardrails/domains/migration-rules.md](../../20-guardrails/domains/migration-rules.md)
