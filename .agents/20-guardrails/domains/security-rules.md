...
- [coding-standards.md](../core/coding-standards.md) — secure coding practices
- [architecture-boundaries.md](../core/architecture-boundaries.md) — data residency rules (Rule 23)
