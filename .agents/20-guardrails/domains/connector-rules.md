...
- [coding-standards.md](../core/coding-standards.md) — general code quality rules
- [architecture-boundaries.md](../core/architecture-boundaries.md) — infrastructure boundary rules
