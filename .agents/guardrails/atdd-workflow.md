...
```
Unit tests are plain MSTest `[TestClass]`/`[TestMethod]` classes, not Reqnroll step definitions. See [ai/guardrails/testing-standards.md](./testing-standards.md) for the required coverage table.
