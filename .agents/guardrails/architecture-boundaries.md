...
25. **Observability is mandatory on every module and tool.** All O-1..O-5 requirements and channel separation rules are enforced by [observability-requirements.md](./observability-requirements.md). Do not duplicate or bypass that contract.
