Feature: NodeStructure configuration and package validation
  As a migration operator
  I want to validate NodeStructure configuration against the package before import
  ...
  Scenario: All paths mapped produces a valid report
    ...
    And a NodeStructure mapping rule maps "SourceProject\Team A" to "TargetProject\Team A"
