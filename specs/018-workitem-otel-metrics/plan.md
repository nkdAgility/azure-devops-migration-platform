...
- [x] **ATDD-First (VIII):** Compliant. The spec contains 5 user stories with 12 acceptance scenarios (Given/When/Then). Each will be implemented via the ATDD inner loop — one scenario per session per commit.
