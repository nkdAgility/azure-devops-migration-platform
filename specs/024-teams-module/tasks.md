...
- [x] T086 Update `docs/module-development-guide.md` — add IdentitiesModule detailed section (name, config, package folder, cursor, behaviour). Note: no DependsOn property.
