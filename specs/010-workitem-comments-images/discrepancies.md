...
### 1. workitems-format-summary.md does not describe `comments.json`
...
### 2. workitems-format-summary.md does not describe embedded-image rewriting
...
### 3. migration-package-concept.md does not include comments or embedded images in the WorkItems layout
...
- **Status**: ✓ Resolved in speckit.implement
  - Updated WorkItems layout diagram in migration-package-concept.md to show comments and embedded images
