...
> **Mandatory context loading confirmed:** All files in `/.agents/guardrails/` (system-architecture.md, workitems-rules.md, migration-rules.md, coding-standards.md, module-template.md) and all files in `/.agents/context/` (package-format.md, workitems-format.md, checkpointing.md, artefact-store.md, job-contract.md, identity-and-mapping.md, import-streaming.md, cli-commands.md) and relevant `/docs/` files (architecture.md, source-types.md, configuration.md, modules.md, tui.md) were read before completing this gate.
