...
### `docs/cli.md` does not describe `discovery dependencies`
- **Source doc**: `docs/cli.md`
- **Section**: (no discovery commands section currently exists in narrative form)
- **Issue**: `docs/cli.md` provides narrative context for CLI commands. The `discovery dependencies` command has no narrative description.
...
### `docs/source-types.md` has no Dependency section per source type
