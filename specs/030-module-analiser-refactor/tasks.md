...
- [X] T049 [US2] **O-1 Traces** — Add `"inventory.workitems"` child span per org in the multi-org loop in `JobAgentWorker`; tag with `org.url` (high-cardinality allowed in traces per telemetry-architecture.md)
