...
- [ ] T033 [P] Update `docs/module-development-guide.md`: add `### WorkItemsModule — ADO Export` subsection describing `IWorkItemRevisionSourceFactory`, `AzureDevOpsWorkItemRevisionSource`, reuse of `WorkItemQueryWindowStrategy`, `IAzureDevOpsAttachmentDownloader`, and the O(N) per-work-item call pattern
