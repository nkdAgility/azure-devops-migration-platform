...
See [docs/module-development-guide.md](modules.md) for the full `IModule` contract and [.agents/guardrails/module-rules.md](../.agents/guardrails/module-rules.md) for the per-module validation checklist.
