...
See [docs/modules.md](modules.md) for the full `IModule` contract and [.agents/guardrails/module-template.md](../.agents/guardrails/module-template.md) for the per-module validation checklist.
