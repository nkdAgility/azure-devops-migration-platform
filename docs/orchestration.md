...
See [docs/tui.md](tui.md) for how the TUI routes a job to the Job Engine. See [docs/job-contract.md](job-contract.md) for the `MigrationJob` schema.
...
See [docs/tui.md](tui.md) for local command details.
