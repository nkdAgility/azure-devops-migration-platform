...
**Audience:** Contributors (human and agent) diagnosing failing tests.
**Purpose:** The mandatory step-by-step procedure for diagnosing and fixing failing tests, with evidence rules, the verification ledger, and diagnostic locations.

The enforceable completion gate for this procedure lives in
[`.agents/20-guardrails/workflow/failing-tests-workflow.md`](../.agents/20-guardrails/workflow/failing-tests-workflow.md).
Violating that gate blocks completion; this document explains how to satisfy it.
...
- [`live-system-testing-guide.md`](live-system-testing-guide.md) — live test environment setup
- [`.agents/20-guardrails/workflow/failing-tests-workflow.md`](../.agents/20-guardrails/workflow/failing-tests-workflow.md) — the enforced completion gate
- [`.agents/20-guardrails/workflow/definition-of-done.md`](../.agents/20-guardrails/workflow/definition-of-done.md) — full completion criteria
