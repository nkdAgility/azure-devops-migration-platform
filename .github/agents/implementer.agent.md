...
**Unit test placement:** `tests/<ProjectName>.Tests/<Area>/<ClassName>Tests.cs` — plain MSTest `[TestClass]`/`[TestMethod]`, not Reqnroll step definitions. See the required coverage table in [agents/testing-standards.md](../../agents/testing-standards.md).
...
- [ ] The required coverage behaviours in [agents/testing-standards.md](../../agents/testing-standards.md) are met for any new module.
