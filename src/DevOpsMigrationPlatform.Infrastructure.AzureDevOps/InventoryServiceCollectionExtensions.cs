...
{
    /// <summary>
    /// Registers all Azure DevOps inventory services and binds <see cref="AnalyserOptions"/>
    ...
    {
        services.AddOptions<AnalyserOptions>().Bind(configuration.GetSection("MigrationPlatform"));
