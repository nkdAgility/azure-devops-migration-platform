...
/// <summary>
/// Azure DevOps SDK-backed implementation of <see cref="IWorkItemTarget"/>.
...
/// </summary>
internal sealed class AzureDevOpsWorkItemTarget : IWorkItemTarget, IDisposable
{
    ...
    public AzureDevOpsWorkItemTarget(WorkItemTrackingHttpClient witClient, string project, string organisationUrl)
    {
