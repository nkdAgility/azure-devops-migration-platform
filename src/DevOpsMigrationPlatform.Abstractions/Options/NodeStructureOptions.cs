...
/// <summary>
/// Root options for the NodeStructure tool.
/// Bound from <c>MigrationPlatform:Tools:NodeStructure</c>.
/// </summary>
public sealed class NodeStructureOptions
{
    /// <summary>Configuration section path.</summary>
    public static string SectionName => "MigrationPlatform:Tools:NodeStructure";
