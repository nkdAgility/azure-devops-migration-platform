...
{
    private Mock<IOptions<MigrationOptions>> _optionsMock = null!;
    ...
    public void Setup()
    {
        ...
        _optionsMock.Setup(o => o.Value).Returns(new MigrationOptions { Policies = new() { Throttle = new() { MaxConcurrency = 4 } } });
